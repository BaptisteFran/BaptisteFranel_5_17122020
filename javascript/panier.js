...
if (clicked == 'true' && clicked != null) {
    ...
    <div class="col m-auto"><p class="text-center"><strong>`+ obj.price + ` €</strong></p></div><div class="col m-auto"><input type="button" class="btn btn-danger" value="Supprimer" id="` + obj.id + `" onClick="del(`+ idTest +`);"></div></div>`;
